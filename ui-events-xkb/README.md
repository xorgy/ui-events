...
# UI Events XKB Mapping

Shared XKB keysym and keymap mapping for the [`ui-events`] Wayland and X11 adapters.
...
[![Crates.io](https://img.shields.io/crates/v/ui-events-xkb.svg)](https://crates.io/crates/ui-events-xkb)
[![Docs](https://docs.rs/ui-events-xkb/badge.svg)](https://docs.rs/ui-events-xkb)

</div>

<!-- We use cargo-rdme to update the README with the contents of lib.rs.
To edit the following section, update it in lib.rs, then run:
cargo rdme --workspace-project=ui-events-xkb --heading-base-level=0
...
This version of UI Events XKB has been verified to compile with **Rust 1.85** and later.

Future versions of UI Events XKB might increase the Rust version requirement.
It will not be treated as a breaking change and as such can even happen with small patch releases.

<details>
<summary>Click here if compiling fails.</summary>

As time has passed, some of UI Events XKB's dependencies could have released versions with a higher Rust requirement.
...
Discussion of UI Events XKB development happens in the [Linebender Zulip](https://xi.zulipchat.com/), specifically the [#general channel](https://xi.zulipchat.com/#narrow/channel/147921-general).
